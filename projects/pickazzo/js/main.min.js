...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function _createClass(e,t,a){return t&&_defineProperties(e.prototype,t),a&&_defineProperties(e,a),e}(function(){var u,d,f;u=window.jQuery,d={ajax:!1,validate:!0,classErr:"error",emailRegex:/^[-a-z0-9~!$%^&*_=+}{\'?]+(\.[-a-z0-9~!$%^&*_=+}{\'?]+)*@([a-z0-9_][-a-z0-9_]*(\.[-a-z0-9_]+)*\.(aero|arpa|biz|com|coop|edu|gov|info|int|mil|museum|name|net|org|pro|travel|mobi|[a-z][a-z])|([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}))(:[0-9]{1,5})?$/i},f=function(){function a(e,t){_classCallCheck(this,a),this.onFormSubmit=this.onFormSubmit.bind(this),this.options=t,this.$form=u(e),this.$form.on("submit",this.onFormSubmit)}return _createClass(a,[{key:"onFormSubmit",value:function(e){var t;return this.options.ajax&&e.preventDefault(),t=!0,this.options.validate&&(t=this.validateInputs()),this.options.ajax&&t&&this.sendForm(),!this.options.ajax&&t}},{key:"validateInputs",value:function(){var e,i,o=this;return e=this.$form.find("[validate]"),i=!0,e.each(function(e,t){var a,n,r;return a=u(t),r=a.attr("validate"),n=a.val(),function(){switch(r){case"text":return 0<n.length;case"email":return this.options.emailRegex.test(n);default:return!0}}.call(o)||(i=!1,a.addClass(o.options.classErr),a.one("focusin",function(e){return u(e.target).removeClass(o.options.classErr)})),!0}),i}},{key:"sendForm",value:function(){return!1}}]),a}(),u.fn.extend({form:function(e){var c=0<arguments.length&&void 0!==e?e:{};return this.each(function(e,t){var a,n,r,i,o,s,l;for(a=u(t),n=String(a.data("form")).toLowerCase().replace(/\s/g,"").split(","),c={},r=0,o=n.length;r<o;r++)i=(s=n[r]).replace(/:[a-z]+/g,""),l=s.replace(/[a-z]+:/g,""),l=function(){switch(l){case"true":return!0;case"false":return!1}}(),c[i]=l;return new f(t,u.extend({},d,c)),!0})}}),u("form[data-form]").form(),$("*[data-tab]").on("click",function(e){var t;return e.preventDefault(),(t=$(this)).siblings().each(function(e,t){var a;return(a=$(t)).removeClass("active"),$("".concat(a.attr("data-tab"))).addClass("d-none")}),t.addClass("active"),$("".concat(t.attr("data-tab"))).removeClass("d-none"),!1}),$("*[data-mask]").each(function(e,t){var a;return(a=$(t)).inputmask("".concat(a.attr("data-mask"))),!0}),$(".js-slider").slick({autoplay:!0,speed:300,arrows:!1,dots:!1,centerMode:!0,focusOnSelect:!0,slidesToShow:3,slidesToScroll:1,centerPadding:"0",mobileFirst:!0,infinite:!0,responsive:[{breakpoint:991,settings:{centerPadding:"170px"}},{breakpoint:1499,settings:{centerPadding:"199px"}}]}),$(".js-slider-view").each(function(e,t){var a,n;return n=(a=$(t)).attr("data-nav"),a.slick({autoplay:!1,dots:!1,speed:300,lazyLoad:"ondemand",slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:n,infinite:!0}),!0}),$(".js-slider-nav").each(function(e,t){var a,n;return n=(a=$(t)).attr("data-view"),a.slick({infinite:!0,autoplay:!1,speed:300,slidesToShow:3,slidesToScroll:1,asNavFor:n,dots:!1,arrows:!1,centerMode:!0,focusOnSelect:!0}),!0}),$("*[data-toggle]").on("click",function(e){var t;return e.preventDefault(),(t=$(this)).toggleClass("active"),$("".concat(t.attr("data-toggle"))).toggleClass("active"),!1})}).call(void 0);